...
@Testcontainers
class SearchSupplierATimeoutEndToEndTest @Autowired constructor(
    ...
    @Test
    fun `supplier A response timeout preserves supplier B offer as partial search`() {
    ...
    companion object {
        ...
        private fun mockSupplierBaseUrl(): String =
            requireNotNull(System.getProperty("e2e.mock-supplier.base-url")) {
                "e2e.mock-supplier.base-url must be configured by the e2eSupplierATimeoutTest task"
            }
    }
}
